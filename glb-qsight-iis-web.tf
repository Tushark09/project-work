resource "google_compute_managed_ssl_certificate" "ssl_iis_web" {
  name        = "sl-cert-${(var.environment)}-iis-web-${var.project_name}"

  managed {
    domains = [
      var.glb_qsight_iis_web_login_domain,
      var.glb_qsight_iis_web_admin_domain,
      var.glb_qsight_iis_web_landingapi_domain,
      var.glb_qsight_iis_web_paramobile_domain,
      var.glb_qsight_iis_web_webapp_domain,
      var.glb_qsight_iis_web_dashboard_domain
    ]
  }
}

# Create a static IP address for the load balancer
resource "google_compute_global_address" "lb_iis_web_ip" {
  name         = "static-lb-iis-web-${var.name_project}-global-ip"
  address_type = "EXTERNAL"
  ip_version   = "IPV4"
}

module "glb-qsight-iis-web" {
  ...
  url_map        = google_compute_url_map.glb-qsight-iis-web[0].self_link
...
resource "google_compute_url_map" "glb-qsight-iis-web" {
  count = var.is_dr_enabled ? 0 : 1
  name            = "um-glb-${var.environment}-qsight-iis-web"
  default_service = module.glb-qsight-iis-web[0].backend_services["ws-qsightlogin-web"].self_link
  ...
  path_matcher {
    ...
    path_rule {
      paths   = ["/*"]
      service = module.glb-qsight-iis-web[0].backend_services["ws-qsightlogin-web"].self_link
    }
  }
  path_matcher {
    name            = "parmobile-web-paths"
    default_service = module.glb-qsight-iis-web[0].backend_services["ws-parmobile-web"].self_link
    path_rule {
      paths   = ["/*"]
      service = module.glb-qsight-iis-web[0].backend_services["ws-parmobile-web"].self_link
    }
  }
  path_matcher {
    name            = "qsightweb-web-paths"
    default_service = module.glb-qsight-iis-web[0].backend_services["ws-qsightweb-web"].self_link
    path_rule {
      paths   = ["/*"]
      service = module.glb-qsight-iis-web[0].backend_services["ws-qsightweb-web"].self_link
    }
  }
  path_matcher {
    name            = "qsightadmin-web-paths"
    default_service = module.glb-qsight-iis-web[0].backend_services["ws-qsightadmin-web"].self_link
    path_rule {
      paths   = ["/*"]
      service = module.glb-qsight-iis-web[0].backend_services["ws-qsightadmin-web"].self_link
    }
  }
  path_matcher {
    name            = "qsightlanding-api-paths"
    default_service = module.glb-qsight-iis-web[0].backend_services["ws-qsightlanding-api"].self_link
    path_rule {
      paths   = ["/*"]
      service = module.glb-qsight-iis-web[0].backend_services["ws-qsightlanding-api"].self_link
    } 
  }
}